 ...
 * @since 1.6
 */
public abstract class MiDefaultRowSorter<M, I> extends RowSorter<M> {
    /**
    ...
    private static class Row implements Comparable<Row> {
        private MiDefaultRowSorter sorter;
        int modelIndex;

        public Row(MiDefaultRowSorter sorter, int index) {
            this.sorter = sorter;
            modelIndex = index;
        }
