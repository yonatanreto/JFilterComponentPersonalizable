...
/*
 * @(#)TableRowSorter.java	1.8 06/03/31
 *
 ...
 * @since 1.6
 */
public class MiTableRowSorter<M extends TableModel> extends MiDefaultRowSorter<M, Integer> {
    /**
     ...
     */
    public MiTableRowSorter(M model) {
        setModel(model);
    }
